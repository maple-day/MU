 ...
 */
public class NewSocietyAdapter extends RecyclerView.Adapter<NewSocietyAdapter.myNewHolder> {
    ...
    public NewSocietyAdapter(List<NewInfo.NewList> datalist, Context context) {
