 ...
 */
public class IntFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("world", new MySubscriberNew() {
            @Override
