 ...
 */
public class SportFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("tiyu", new MySubscriberNew() {
            @Override
