 ...
 */
public class AnecdoteFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("qiwen", new MySubscriberNew() {
            @Override
