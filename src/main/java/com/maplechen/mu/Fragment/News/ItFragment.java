...
import com.maplechen.mu.Adapter.NewItAdapter;
 ...
 */
public class ItFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    protected void InitView() {
        ...
        adapter = new NewItAdapter(newslist,getActivity());
        recyclerView.setAdapter(adapter);
        recyclerView.refresh();
        adapter.setOnItemClickListener(new NewItAdapter.OnRecyclerViewItemClickListener() {
            @Override
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("it", new MySubscriberNew() {
            @Override
