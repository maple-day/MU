 ...
 */
public class DisportFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("huabian", new MySubscriberNew() {
            @Override
