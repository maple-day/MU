 ...
 */
public class DomesticFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void onRefresh() {
        RetrofitNew.getInstance(this.getContext()).getJson("guonei", new MySubscriberNew() {
            @Override
